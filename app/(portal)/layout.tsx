...
const ALL_NAV: NavItem[] = [
  ...
  // 2026-06-28 — CA-only test-data cleanup screen. Clears practice
  // subscriptions (and their cascade) ahead of client training going
  // live. Soft-delete only; no scheduled purge. See
  // project_rootstalk_ca_admin_test_cleanup_2026_06_27.md.
  { href: '/cleanup',            label: 'Cleanup',           Icon: IconTrash,        group: 'PORTAL', caOnly: true },
