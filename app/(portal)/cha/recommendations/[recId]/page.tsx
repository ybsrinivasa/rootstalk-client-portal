    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <PracticeFormModal
        ...
        usedCommonNames={(() => {
          ...
          // this Timeline. Backend rejects duplicates; UI greys them
          // out so the SE never picks a CN that won't save.
